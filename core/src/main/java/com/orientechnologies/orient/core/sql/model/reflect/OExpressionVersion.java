 ...
 */
public final class OExpressionVersion extends OExpressionAbstract {

  public OExpressionVersion() {
    this(null);
  }
  
  public OExpressionVersion(String alias) {
    super(alias);
  }
  ...
  @Override
  public OExpressionVersion copy() {
    return new OExpressionVersion(alias);
  }
